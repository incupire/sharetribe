class Admin::TestimonialsService
  ...
  FILTER_STATUSES = %w(positive negative skipped waiting)
  ...
  def filtered_scope
    ...
    review_statuses = []
    review_statuses.push(Testimonial.positive) if status_checked?('positive')
    review_statuses.push(Testimonial.negative) if status_checked?('negative')
