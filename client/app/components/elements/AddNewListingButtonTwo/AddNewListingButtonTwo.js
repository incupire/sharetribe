...
import css from './AddNewListingButtonTwo.css';

const HOVER_COLOR_BRIGHTNESS = 80;

export default function AddNewListingButtonTwo({ text, url, customColor, className, mobileLayoutOnly }) {
...
AddNewListingButtonTwo.propTypes = {
