...
import css from './AddNewListingButtonThree.css';

const HOVER_COLOR_BRIGHTNESS = 80;

export default function AddNewListingButtonThree({ text, url, customColor, className, mobileLayoutOnly }) {
...
AddNewListingButtonThree.propTypes = {
