...
Rails.application.routes.draw do
  ...
  get '/contact_page' => "feedbacks#contact_page"
  get '/privacy_page' => "infos#privacy_page"
  get '/terms_and_conditions_page' => "infos#terms_and_condition"
  ...
  scope "(/:locale)", :constraints => { :locale => locale_matcher } do
    ...
    post '/update_email_subject' => "mercury_update#update_email_subject", :as => :update_email_subject
    ...
    get '/:person_id/settings/stripe_customber' => 'payment_settings#stripe_customer', :as => :person_stripe_customber_settings
    get  '/:person_id/settings/stripe_customber/edit' => 'payment_settings#edit_stripe_customer', :as => :person_edit_stripe_customber_settings
    put '/:person_id/settings/update_stripe_customer' => 'payment_settings#update_stripe_customer', as: :person_update_stripe_customer_settings
      ...
      resources :people, except: [:show], :path => "" do
        ...
        resources :messages, :controller => :conversations do
          ...
          member do
            ...
            get :cancel_coupon_pay, to: 'confirm_conversations#cancel_coupon_pay'
